...
function getWeather(latitude, longitude){  
    ...
    fetch(api)  
        ...
        const { main, name, sys, weather } = data;
         ...
         text='"Current Weather in"+${name}+"is"+${main}'; 
 responsiveVoice.speak(text);	
        })	        
} 	
    }
...
else if(wo[i]==="Reboot13" || wo[i]==="reboot13"||wo[i]==="reboot13-git"||wo[i]==="Reboot13-git")
{
    text="He's my creator,If you want to know more about him tap on google logo in footer below";
    document.getElementById('ans').innerHTML=text;
    flag=2;
    responsiveVoice.speak(text);
}
